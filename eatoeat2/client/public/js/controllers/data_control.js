...
app.controller('location_controller', ['$scope', '$http','$cookieStore','$location', function ($scope, $http,$cookieStore,$location) {
...
app.controller('home_controller', ['$scope', '$http','$rootScope','$cookieStore', function ($scope, $http,$rootScope,$cookieStore) {
...
app.controller('cook_controller', ['$scope', '$http','$rootScope', function ($scope, $http,$rootScope) {
...
app.controller('cook_register', ['$scope', '$http','$location','$cookieStore','$timeout','$base64','$window','$rootScope', function ($scope, $http,$location,$cookieStore,$timeout,$base64,$window,$rootScope) {
...
app.controller('user_register', ['$scope', '$http','$location','$cookieStore','$timeout','$routeParams','$base64','$rootScope', function ($scope, $http,$location,$cookieStore,$timeout,$routeParams,$base64,$rootScope) {
...
app.controller('admin_controller', ['$scope', '$http','$rootScope','$timeout','$base64', function ($scope, $http,$rootScope,$timeout,$base64) {
...
(function () {
    angular.module('autoActive', ['ngCookies','ckeditor','720kb.datepicker','base64','ngFileUpload'])
